...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        gain = current_score - running_high
        if gain > last_score:
            print("{} point(s)! That's a record gain for Player {}!".format(
                gain, who))
        return announce_highest(who, max(gain, last_score), current_score)
    return say
    # END PROBLEM 7
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if opponent_score != 0:
        if score == 0:
            ...
            if gap > 8 and gap <= 24:
                if gap // 6 == 3 and gap % 6 > 0:
                    return 4
                elif gap // 6 == 2 and gap % 6 > 0:
                    return 3
                elif gap // 6 == 1 and gap % 6 > 0:
                    return 2
                else:
                    if gap // 6 == 4:
                        return 4
